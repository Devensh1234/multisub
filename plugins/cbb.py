...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "about":
        await query.message.edit_text(
            text = f"<b>○ 🖤 ᴍʏ ᴄʀᴇᴀᴛᴏʀ : @BINARYQUEST \n○ ❤️‍🔥ᴍʏ ᴄʜᴀɴɴᴇʟ : @BinaryQuest \n○ 🔥Library : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio {__version__}</a>\n○ 🥶sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ  : <a href='https://t.me/itz_sahil_official'>ᴘʀɪᴠᴀᴛᴇ ᴄᴏᴅᴇ</a>\n○ 🥵 ᴅᴏɴᴀᴛᴇ ᴍᴇ : <a href='https://t.me/sahil_X_official'>ᴄʟɪᴄᴋ ᴍᴇ</a></b>",
            disable_web_page_preview = True,
            reply_markup = InlineKeyboardMarkup(
                [
                    [
                    InlineKeyboardButton("⚡️ ᴄʟᴏsᴇ", callback_data = "close"),
                    InlineKeyboardButton('🍁 ᴍʏ ᴄʜᴀɴɴᴇʟ', url='https://t.me/BinaryQuest')
                    ]
                ]
            )
        )
